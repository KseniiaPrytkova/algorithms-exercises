...
// STACK (true stack also has peak etc)
// not checking for errors etc
class ArrayList {
	// evertime I hit new ArrayList() - the constructor() method gets run
	constructor() {
	...
	push(value) {
		// add at item to the end of the array
	...
	// the whole REASON for ArrayList: get() is very fast and simple
	get(index) {
		// returns that item from the array
		// check bounds! and then:
		return this.data[index];
	}

	delete(index) {
		// removes item from the array and collapses (shift everything over) the array
